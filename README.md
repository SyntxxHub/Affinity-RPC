...
## Notes
- Only shows which app is open, not the file you're working on (Doesn't show which file you're editing yet)
- Right-click the tray icon and click **Quit** to exit
